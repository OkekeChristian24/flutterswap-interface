# Contributing to the Flutterswap ecosystem 🥞

Thanks for taking the time to contribute !
You can start by reading our [Contribution guidelines](https://docs.flutterswap.finance/code/contributing) first.
...
Translation in crowdin: `%asset% Earned` [link](https://crowdin.com/translate/flutterswapswap/8/en-de#330)
